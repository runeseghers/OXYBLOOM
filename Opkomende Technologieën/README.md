...
1. Als eerste hebben we in [code_1](https://github.com/runeseghers/OXYBLOOM/blob/main/tests/code_1_motor_draait_en_kalibreert/code_1_motor_draait_en_kalibreert.ino) de motor laten kalibreren door hem naar één kant te laten roteren. Dit hebben we gedaan omdat stappenmotoren hun positie niet kunnen onthouden.
2. Dan hebben we de motor laten besturen door een luchtvochtigheidssensor([datasheet sensor](https://www.mouser.com/datasheet/2/758/DHT11-Technical-Data-Sheet-Translated-Version-1143054.pdf?srsltid=AfmBOorO1tDjnJdzTmvuW-I0MY3YAzV3U6862pVDsvfQup3PF48_19x4)) in [code_2](https://github.com/runeseghers/OXYBLOOM/blob/main/tests/code_2_motor_werkt_met_de_vochtigheidssensor/code_2_motor_werkt_met_de_vochtigheidssensor.ino).
...
4. De motor wordt niet alleen bestuurt aan de hand van de luchtvochtigheid maar ook door de co2 waarde in een ruimte. Dit kan je zien in [code_5](https://github.com/runeseghers/OXYBLOOM/blob/main/tests/code_5_motorwerktopco2envocht/code_5_motorwerktopco2envocht.ino). Ook worden de waarden continu geprint zodat het makkelijker is voor ons om te programmeren. Bij deze code hadden we een foutje opgemerkt namelijk bij het opstarten en wanneer de luchtkwaliteit slecht werd, was de led groen en die moest rood zijn. Deze fout hebben we aangepast in [code_6](https://github.com/runeseghers/OXYBLOOM/blob/main/tests/code_6_zonder_led_fout/code_6_zonder_led_fout.ino).
